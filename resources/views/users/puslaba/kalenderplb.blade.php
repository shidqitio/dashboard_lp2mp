@extends('users.puslaba.layout.sidebar2')
...
<div class="modal-body">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="/eventpagepuslaba" class="btn btn-success" style="margin-top: 5px "> Kalender </a>
            ...
            <div class="table-responsive">
                <table class="table table-bordered bg-dark example1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if($kalenders->penanggung_jawab == auth()->user()->role )
                                <button type="button" class="btn-warning btn-sm" data-role="update" data-toggle="modal"
                                    data-id="{{$kalenders->id}}" data-target="#edit_{{$kalenders->id}}"
                                    style="margin: 5px 2px 3px 2px;">
                                    Ubah
                                </button>
                                <!-- Button trigger modal -->
                                <button type="button" class="btn-danger btn-sm" data-toggle="modal"
                                    data-target="#destroy_{{$kalenders->id}}" style="margin: 5px 2px 3px 2px;">
                                    Hapus
                                </button>
                                @endif
                                <!-- Modals for Edit -->
                                <form method="post" action="{{ url('/kalender/update', ['id'=>$kalenders->id] ) }}">
                                    {{ csrf_field() }}
                                    <div class="modal fade" id="edit_{{$kalenders->id}}" data-id="{{$kalenders->id}}"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <input type="text" class="form-control" id="id_edit" name="id"
                                                        placeholder="Nama Kegiatan" value="{{$kalenders->id}}" hidden>
                                                    <div class="form-group">
                                                        <label for="Nama Kegiatan">Nama Kegiatan</label>
                                                        <input type="text" class="form-control" name="nama_kegiatan"
                                                            placeholder="Nama Kegiatan"
                                                            value="{{$kalenders->nama_kegiatan}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Unit" class="">Unit Terlibat</label>
                                                        <br />
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="unit2" class="form-control" name="penanggung_jawab"
                                                            required>
                                                            <option value="{{$kalenders->penanggung_jawab}}">
                                                                {{$kalenders->penanggung_jawab}}</option>
                                                            <option value="SEKRETARIAT">SEKRETARIAT</option>
                                                            <option value="PUSJIAN">PUSJIAN</option>
                                                            <option value="PUSLABA">PUSLABA</option>
                                                            <option value="P2M2">P2M2</option>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="color">Warna</label>
                                                        <input type="color" class="form-control" id="color2"
                                                            name="color" placeholder="Color"
                                                            value="{{$kalenders->color}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Tanggal Mulai">Tanggal Mulai Kegiatan</label>
                                                        <input type="date" class="form-control" name="tanggal_mulai"
                                                            value="{{$kalenders->tanggal_mulai}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Tanggal Selesai">Tanggal Selesai Kegiatan</label>
                                                        <input type="date" class="form-control" name="tanggal_selesai"
                                                            value="{{$kalenders->tanggal_selesai}}">
                                                    </div>
                        ...
                        <!-- Modal For Delete -->
                        <div class="modal fade" id="destroy_{{$kalenders->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-dismiss="modal">Batal</button>
                                        <a id="delete-btn" href="{{url ('/kalender/destroy', ['id'=>$kalenders->id] ) }}"
