...
<div class="modal-body">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <a href="/eventpagepbb" class="btn btn-success" style="margin-top: 5px "> Kalender </a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="pj2_{{$kalenders->id}}" class="form-control" name="penanggung_jawab" required>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="color">Warna</label>
                                                        <input type="color" class="form-control" id="color2_{{$kalenders->id}}" name="color" placeholder="Color" value="{{$kalenders->color}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Tanggal Mulai">Tanggal Mulai Kegiatan</label>
