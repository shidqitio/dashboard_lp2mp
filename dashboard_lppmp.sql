...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2021 at 04:42 AM
...
(145, 'vcs', 2, 'adaadada', '2021-07-24', '17 TAHUN 2019- HARGA BAHAN AJAR (1).pdf', 100, 5500, 1100, 550, 137.5, 825, 825, 8937.5, 446.875, 715, 625.625, 10725, 10730);
...
(145, 145, 2146, 429, 1073, 644, 15022, 1669, 16691, 16700);
...
(15, 'admin', 'admin@gmail.com', '$2y$10$qP1CIuz/LTFbeC11cRcc4OqUHHlE9bDwcT0vf9VIBI.v8vWG7CogC', 'LPPMP', 'UFFw03G0cAVtpdoR30RMow7oaa0YSLwutiDxe5reqjaNGWDJmCwY5j2lIFIX', '2020-07-12 18:54:11', '2020-07-12 18:54:11'),
...
(24, 'Dini', 'diniemiria@ecampus.ut.ac.id', '$2y$10$SO3K0HGLcU6dtPtwtUBl/ul.RCcVIKeYdUwSBJ0eF5QsO3XVObOOu', 'ADMIN', NULL, '2021-05-28 00:37:25', '2021-05-28 00:37:25');
...
--
ALTER TABLE `harga_buku`
  MODIFY `id_harga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=146;
